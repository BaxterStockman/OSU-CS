...
//  Last Modification Date:     07/07/2013 11:07:21 PM
...
// Sine of 90 degrees minus the cosine of 30 degrees
double trigDifference = sin((90 * M_PI) / 180) - cos((30 * M_PI) / 180) * (180 / M_PI);
...
// Prints the values of the variables defined about to the console
int main()
{
    cout << "2 raised to the 32nd power minus 1 is " << twoToThirtySecondLessOne << "\n";
    ...
    cout << "The sine of 90 degrees minus the cosine of 30 degrees is " << trigDifference << " degrees\n";
    cout << "The natural log of 5 is " << logNatFive << "\n";
    cout << "The log base 10 of 100 is " << logTenTen << "\n";
